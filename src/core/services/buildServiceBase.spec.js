...
describe('core/services/buildServiceBase', function() {
	...
	describe('activeProjects', function() {
		...
		// TODO: !(TestScheduler instanceof Scheduler) on timer ?
		xit('should push lastest state on activeProjects subscription', function() {
		...
		// TODO: !(TestScheduler instanceof Scheduler) on timer ?
		xit('should push updated build states every time an event is published', function() {
			service.start().subscribe();
		...
		// TODO: .not is not working for undefined values
		xit('should not push new state if service stopped', function() {
			service.start().subscribe();
			service.stop();
		...
		// TODO: !(TestScheduler instanceof Scheduler) on timer ?
		xit('should push latest state on update', function() {
