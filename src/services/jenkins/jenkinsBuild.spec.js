define([
	...
	describe('services/jenkins/jenkinsBuild', function () {
		...
		beforeEach(function () {
			...
			jobJson = JSON.parse(readFixtures('src/services/jenkins/job.fixture.json'));
			lastCompletedBuildJson = JSON.parse(readFixtures('src/services/jenkins/lastCompletedBuild.fixture.json'));
			var callCount = 0;
