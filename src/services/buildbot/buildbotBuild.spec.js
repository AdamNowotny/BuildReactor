define([
	...
	describe('services/buildbot/buildbotBuild', function () {
		...
		beforeEach(function () {
			...
			builderJson = JSON.parse(readFixtures('src/services/buildbot/builder.fixture.json'));
			lastCompletedBuildJson = JSON.parse(readFixtures('src/services/buildbot/lastCompleted.fixture.json'));
			var callCount = 0;
